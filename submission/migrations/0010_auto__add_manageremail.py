...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ManagerEmail'
        db.create_table(u'submission_manageremail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=30)),
        ))
        db.send_create_signal(u'submission', ['ManagerEmail'])


    def backwards(self, orm):
        # Deleting model 'ManagerEmail'
        db.delete_table(u'submission_manageremail')
