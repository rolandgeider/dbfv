...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BankAccount.account_nr'
        db.delete_column(u'submission_bankaccount', 'account_nr')

        # Deleting field 'BankAccount.bank_nr'
        db.delete_column(u'submission_bankaccount', 'bank_nr')

        # Adding field 'BankAccount.iban'
        db.add_column(u'submission_bankaccount', 'iban',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=34),
                      keep_default=False)

        # Adding field 'BankAccount.bic'
        db.add_column(u'submission_bankaccount', 'bic',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BankAccount.account_nr'
        raise RuntimeError("Cannot reverse this migration. 'BankAccount.account_nr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BankAccount.account_nr'
        db.add_column(u'submission_bankaccount', 'account_nr',
                      self.gf('django.db.models.fields.CharField')(max_length=9),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'BankAccount.bank_nr'
        raise RuntimeError("Cannot reverse this migration. 'BankAccount.bank_nr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BankAccount.bank_nr'
        db.add_column(u'submission_bankaccount', 'bank_nr',
                      self.gf('django.db.models.fields.CharField')(max_length=8),
                      keep_default=False)

        # Deleting field 'BankAccount.iban'
        db.delete_column(u'submission_bankaccount', 'iban')

        # Deleting field 'BankAccount.bic'
        db.delete_column(u'submission_bankaccount', 'bic')
