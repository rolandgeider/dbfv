...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubmissionStarter.submission_status_bv'
        db.delete_column(u'submission_submissionstarter', 'submission_status_bv')

        # Deleting field 'SubmissionStarter.submission_type'
        db.delete_column(u'submission_submissionstarter', 'submission_type')

        # Adding field 'SubmissionStarter.submission_status'
        db.add_column(u'submission_submissionstarter', 'submission_status',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubmissionStarter.submission_status_bv'
        db.add_column(u'submission_submissionstarter', 'submission_status_bv',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)

        # Adding field 'SubmissionStarter.submission_type'
        db.add_column(u'submission_submissionstarter', 'submission_type',
                      self.gf('django.db.models.fields.CharField')(default='ST', max_length=2),
                      keep_default=False)

        # Deleting field 'SubmissionStarter.submission_status'
        db.delete_column(u'submission_submissionstarter', 'submission_status')
