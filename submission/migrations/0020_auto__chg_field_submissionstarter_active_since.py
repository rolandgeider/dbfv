...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionStarter.active_since'
        db.alter_column(u'submission_submissionstarter', 'active_since', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'SubmissionStarter.active_since'
        db.alter_column(u'submission_submissionstarter', 'active_since', self.gf('django.db.models.fields.DateField')())
