...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submission_submissiongym', (
            ...
            ('fax_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=30)),
            ('members', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('submission_status', self.gf('django.db.models.fields.CharField')(default='1', max_length=2)),
        ))
        db.send_create_signal(u'submission', ['SubmissionGym'])


    def backwards(self, orm):
        # Deleting model 'SubmissionGym'
        db.delete_table(u'submission_submissiongym')
