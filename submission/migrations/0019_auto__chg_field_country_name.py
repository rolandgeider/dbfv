...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'submission_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Country.name'
        db.alter_column(u'submission_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
