...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gym.owner'
        db.add_column(u'submission_gym', 'owner',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gym.zip_code'
        db.add_column(u'submission_gym', 'zip_code',
                      self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gym.city'
        db.add_column(u'submission_gym', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Gym.street'
        db.add_column(u'submission_gym', 'street',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Gym.email'
        db.alter_column(u'submission_gym', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

    def backwards(self, orm):
        # Deleting field 'Gym.owner'
        db.delete_column(u'submission_gym', 'owner')

        # Deleting field 'Gym.zip_code'
        db.delete_column(u'submission_gym', 'zip_code')

        # Deleting field 'Gym.city'
        db.delete_column(u'submission_gym', 'city')

        # Deleting field 'Gym.street'
        db.delete_column(u'submission_gym', 'street')


        # Changing field 'Gym.email'
        db.alter_column(u'submission_gym', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))
