...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.nationality'
        db.add_column(u'submission_submission', 'nationality',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=37, to=orm['submission.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.nationality'
        db.delete_column(u'submission_submission', 'nationality_id')
