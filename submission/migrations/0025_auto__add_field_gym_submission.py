...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionGym.gym'
        db.add_column(u'submission_submissiongym', 'gym',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submission.Gym'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionGym.gym'
        db.delete_column(u'submission_submissiongym', 'gym_id')
    ...
    models = {
        ...
        u'submission.submissiongym': {
            ...
            'gym': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['submission.Gym']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
