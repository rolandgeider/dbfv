...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'State.email'
        db.alter_column(u'submission_state', 'email', self.gf('django.db.models.fields.EmailField')(max_length=120))

    def backwards(self, orm):

        # Changing field 'State.email'
        db.alter_column(u'submission_state', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))
