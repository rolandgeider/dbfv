    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account', models.ForeignKey(verbose_name=b'Bankkonto', to='submission.BankAccount')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gym', models.OneToOneField(null=True, editable=False, to='submission.Gym', blank=True, verbose_name=b'Studio')),
                ('state', models.ForeignKey(verbose_name='Landesverband', to='submission.State')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.ForeignKey(blank=True, to='submission.State', null=True)),
