    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'owner_name',
                    models.CharField(max_length=100, verbose_name=b'Beg\xc3\xbcnstigter')
                ),
                ('iban', models.CharField(max_length=34, verbose_name=b'IBAN')),
                (
                    'bic',
                    models.CharField(
                        help_text='Nur bei Auslands\xfcberweisung n\xf6tig',
                        max_length=11,
                        verbose_name=b'BIC'
                    )
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'email',
                    models.EmailField(max_length=75, null=True, verbose_name=b'Email', blank=True)
                ),
                (
                    'owner',
                    models.CharField(
                        max_length=100, null=True, verbose_name=b'Inhaber', blank=True
                    )
                ),
                (
                    'zip_code',
                    models.IntegerField(max_length=5, null=True, verbose_name='PLZ', blank=True)
                ),
                (
                    'city',
                    models.CharField(max_length=30, null=True, verbose_name='Ort', blank=True)
                ),
                (
                    'street',
                    models.CharField(
                        max_length=30, null=True, verbose_name='Stra\xdfe', blank=True
                    )
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=2,
                        choices=[
                            (b'1', b'Eingegangen'), (b'2', b'Bewilligt'), (b'3', b'Abgelehnt')
                        ]
                    )
                ),
                ...
                (
                    'name',
                    models.CharField(
                        help_text='Name des Studios oder Verein',
                        max_length=30,
                        verbose_name='Name'
                    )
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'email',
                    models.EmailField(max_length=120, null=True, verbose_name='Email', blank=True)
                ),
                (
                    'state',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'weight',
                    models.DecimalField(
                        verbose_name='Wettkampfgewicht (kg)', max_digits=5, decimal_places=2
                    )
                ),
                (
                    'category',
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (b'5', 'Juniorenklasse'), (b'6', 'Classic-Bodybuilding'),
                            (b'7', 'Paare'), (b'8', 'M\xe4nner Physique'),
                            (b'9', 'M\xe4nner Bodyklasse')
                        ]
                    )
                ),
                (
                    'submission_last_year',
                    models.BooleanField(
                        default=False,
                        verbose_name='Im Vorjahr wurde bereits eine Lizenz beantragt'
                    )
                ),
                (
                    'gym',
                    models.ForeignKey(
                        verbose_name=b'Studio', to='submission.Gym', on_delete=models.CASCADE
                    )
                ),
                (
                    'nationality',
                    models.ForeignKey(
                        default=37,
                        verbose_name='Staatsangeh\xf6rigkeit',
                        to='submission.Country',
                        on_delete=models.CASCADE
                    )
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=-1,
                        max_length=1,
                        choices=[(2, 'Bundesverband'), (3, 'User'), (-1, 'Unbekannt')]
                    )
                ),
                (
                    'state',
                    models.ForeignKey(
                        blank=True, to='submission.State', null=True, on_delete=models.CASCADE
                    )
                ),
                (
                    'user',
                    models.OneToOneField(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
                ),
            ],
            options={},
            bases=(models.Model, ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name=b'Bundesland', to='submission.State', on_delete=models.CASCADE
            ),
