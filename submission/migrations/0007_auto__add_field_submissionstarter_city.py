...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionStarter.city'
        db.add_column(u'submission_submissionstarter', 'city',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionStarter.city'
        db.delete_column(u'submission_submissionstarter', 'city')
