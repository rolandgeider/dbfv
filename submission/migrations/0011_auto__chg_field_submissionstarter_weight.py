...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionStarter.weight'
        db.alter_column(u'submission_submissionstarter', 'weight', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'SubmissionStarter.weight'
        db.alter_column(u'submission_submissionstarter', 'weight', self.gf('django.db.models.fields.IntegerField')(max_length=3))
