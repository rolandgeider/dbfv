...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionStarter.mail_merge'
        db.add_column(u'submission_submissionstarter', 'mail_merge',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionStarter.mail_merge'
        db.delete_column(u'submission_submissionstarter', 'mail_merge')
