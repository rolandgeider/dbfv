...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionGym.email'
        db.alter_column(u'submission_submissiongym', 'email', self.gf('django.db.models.fields.EmailField')(max_length=120))

        # Changing field 'SubmissionJudge.email'
        db.alter_column(u'submission_submissionjudge', 'email', self.gf('django.db.models.fields.EmailField')(max_length=120, null=True))

    def backwards(self, orm):

        # Changing field 'SubmissionGym.email'
        db.alter_column(u'submission_submissiongym', 'email', self.gf('django.db.models.fields.EmailField')(max_length=30))

        # Changing field 'SubmissionJudge.email'
        db.alter_column(u'submission_submissionjudge', 'email', self.gf('django.db.models.fields.EmailField')(max_length=30, null=True))
