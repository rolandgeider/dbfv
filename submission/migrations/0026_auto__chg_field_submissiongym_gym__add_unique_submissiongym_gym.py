...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionGym.gym'
        db.alter_column(u'submission_submissiongym', 'gym_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['submission.Gym'], unique=True, null=True))
        # Adding unique constraint on 'SubmissionGym', fields ['gym']
        db.create_unique(u'submission_submissiongym', ['gym_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubmissionGym', fields ['gym']
        db.delete_unique(u'submission_submissiongym', ['gym_id'])


        # Changing field 'SubmissionGym.gym'
        db.alter_column(u'submission_submissiongym', 'gym_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['submission.Gym'], null=True))
    ...
    models = {
        ...
        u'submission.submissiongym': {
            ...
            'gym': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['submission.Gym']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'submission.submissionjudge': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
