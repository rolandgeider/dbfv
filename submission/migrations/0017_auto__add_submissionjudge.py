...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubmissionJudge'
        db.create_table(u'submission_submissionjudge', (
        ...
        db.send_create_signal(u'submission', ['SubmissionJudge'])


    def backwards(self, orm):
        # Deleting model 'SubmissionJudge'
        db.delete_table(u'submission_submissionjudge')
